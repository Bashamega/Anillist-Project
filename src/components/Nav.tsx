...
export function Nav({setVal}:{setVal:React.Dispatch<React.SetStateAction<string>>}){
    ...
    return(
        <nav className="lg:m-10 p-5 bg-blue-500 rounded-lg relative shadow-xl">
            <h1 className=" text-2xl text-white border p-1 rounded text-center">Anilist Project | Unofficial</h1>
            <section className=" p-5 absolute left-0 lg:w-1/2 w-full flex  lg:left-1/4 bg-white rounded lg:shadow-lg">
